...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/loky-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4590&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/loky-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `loky` can be installed with:

```
conda install loky
```

It is possible to list all of the versions of `loky` available on your platform with:
